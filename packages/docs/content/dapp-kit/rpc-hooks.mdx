...
```tsx
import { useSuiClientQueries } from '@onelabs/dapp-kit';
...
```tsx
import { useSuiClientInfiniteQuery } from '@onelabs/dapp-kit';
...
```tsx
import { useSuiClientMutation } from '@onelabs/dapp-kit';
...
```tsx
import { useResolveSuiNSName } from '@onelabs/dapp-kit';
