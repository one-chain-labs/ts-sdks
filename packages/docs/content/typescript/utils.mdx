---
title: The `@onelabs/sui/utils` package
---

This package contains some utilities that simplify common operations when working with the OneChain
TypeScript SDK.
...
- `SUI_ADDRESS_LENGTH`: The number of bytes in a OneChain address (32)
- `MOVE_STDLIB_ADDRESS`: The address for the OneChain Move standard library
- `SUI_FRAMEWORK_ADDRESS`: The address for the OneChain Framework
- `SUI_SYSTEM_ADDRESS`: The address for the OneChain System module
