...
The OneChain TypeScript SDK provides `Keypair` classes that handle logic for signing and verification
using the cryptographic key pairs associated with a Sui address.

The OneChain TypeScript SDK supports three signing schemes:
...
To use, import the key pair class your project uses from the `@onelabs/sui/keypairs` folder. For
example, to use the Ed25519 scheme, import the `Ed25519Keypair` class from
`@onelabs/sui/keypairs/ed25519`.
...
```typescript
import { Ed25519Keypair, Ed25519PublicKey } from '@onelabs/sui/keypairs/ed25519';
...
import { Ed25519Keypair } from '@onelabs/sui/keypairs/ed25519';
import { verifyTransactionSignature } from '@onelabs/sui/verify';
...
The OneChain TypeScript SDK supports deriving a key pair from a mnemonic phrase. This can be useful when
...
```typescript
import { decodeSuiPrivateKey, encodeSuiPrivateKey } from '@onelabs/sui/cryptography';
import { Ed25519Keypair } from '@onelabs/sui/keypairs/ed25519';
