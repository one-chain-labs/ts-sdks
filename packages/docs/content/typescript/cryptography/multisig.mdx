...
The OneChain TypeScript SDK provides a `MultiSigPublicKey` class to support
...
transaction is equal to or greater than the threshold value, then the OneChain network considers the
transdaction valid.
