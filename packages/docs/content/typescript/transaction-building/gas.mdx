---
title: Paying for Oct Transactions with Gas Coins
---

With Programmable Transactions, you can use the gas payment coin to construct coins with a set
balance using `splitCoin`. This is useful for Oct payments, and avoids the need for up-front coin
...
**Note:** The gas budget is represented in Oct, and should take the gas price of the transaction
into account.
